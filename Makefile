...
#    Updated: 2025/11/12 19:18:48 by lyvan-de         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #

NAME = miniRT
BUILD_DIR = ./build
SRC = main.c graphics.c create_data.c vector.c vector2.c viewport.c ray.c render.c parsing.c parse_objects.c parse_utils.c
