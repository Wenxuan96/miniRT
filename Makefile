...
#    Updated: 2026/01/27 16:56:13 by wxi              ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = src/parsing/parse_file.c src/parsing/parse_obj_helper.c src/parsing/parse_objects.c src/parsing/parse_scene_setup.c src/parsing/parse_tuple.c src/parsing/parse_utils.c src/parsing/scene.c \
	src/vectors/vec_utils1.c src/vectors/vec_utils2.c src/matrices/matrices.c src/matrices/mat_invert.c src/matrices/transformation.c src/render/color_utils.c\
	src/miniRT.c src/render/color.c src/objects/cylinder.c src/objects/hit_objects.c src/render/lighting.c src/objects/ray.c src/objects/viewport.c src/objects/sphere.c src/objects/plane.c 
